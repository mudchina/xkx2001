...
void create()
{
	...
	set("exits", ([
		"north" : "/d/bwdh/sjsz/wzoulan",
		"west" : "/d/bwdh/sjsz/wgarden",
		"east" : "/d/bwdh/sjsz/wtang",
	]));
...
int do_plant(string arg) {
	...
	if ( !me->query("sjsz/red") ) return notify_fail("这可不是你的地盘。\n");
	...
	CHANNEL_D->do_channel(this_object(), "rumor",
		"听说"+me->name()+"将"+flag->query("name")+"插到了试剑亭！" );		
