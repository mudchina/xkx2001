...
string ask_me(string name)
{
	...
	if ( name == "quanzhou" )
	say(CYN "\n店小二笑道：这里就是泉州城了，咱这泉州城的好地方多着呢，可是三天三夜也数不尽 ... \n\n" NOR);
	...
	if ( name == "huashan" )
	say(CYN "\n店小二笑道：华山派在扬州城的北面。出了北门向西北而行，经过华山南村口到达打谷场，便\n"
		"            转道向东。你将会来到华山脚下。一路上山就可到达镇岳宫。小的并不十分清楚华\n"
		"	     山派的确实地点，只知是在那儿附近，请客官多多包涵。\n\n" NOR);
...
{
	tell_object(who, "小二笑嘻嘻地说：小店今天不做生意。\n");
	return;
	who->set_leader(me);
//	command("go up", me);                        
	
	tell_object(who, "小二笑嘻嘻地说：客官您算找对地方了，我们这儿是泉州最干净的客店。
