...
int start()
{
	...
	for( i = j;i<6;i++)
	{
	  if(i==0){ob1=new( bd_fighters[i] );ob1->move(environment(me));message_vision(HIY"$N快步走了过来，作楫道：有劳各位道兄久等了！\n"NOR, ob1);}
	  else if(i==1){ob2=new( bd_fighters[i] );ob2->move("/d/zhongnan/dajiaochang");message_vision(HIY"$N快步走了过来，作楫道：有劳各位道兄久等了！\n"NOR, ob2);}
	  else if(i==2){ob3=new( bd_fighters[i] );ob3->move("/d/zhongnan/dajiaochang");message_vision(HIY"$N快步走了过来，作楫道：有劳各位道兄久等了！\n"NOR, ob3); }
	  else if(i==3){ob4=new( bd_fighters[i] );ob4->move("/d/zhongnan/dajiaochang");message_vision(HIY"$N快步走了过来，作楫道：有劳各位道兄久等了！\n"NOR, ob4); }
	  else if(i==4){ob5=new( bd_fighters[i] );ob5->move("/d/zhongnan/dajiaochang");message_vision(HIY"$N快步走了过来，作楫道：有劳各位道兄久等了！\n"NOR, ob5); }
	  else if(i==5){ob6=new( bd_fighters[i] );ob6->move("/d/zhongnan/dajiaochang");message_vision(HIY"$N快步走了过来，作楫道：有劳各位道兄久等了！\n"NOR, ob6); }
	}
