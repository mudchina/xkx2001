...
void create()
{
	set_name("文清小师太", ({"wenqing", "wen qing"}) );
...
//	if( !who->query_temp("marks/sit") ) return;
	...
	message_vision("文清拿出一碟新鲜的水蜜桃，又沏了杯香茶给$N。\n", who);
	ob = new("d/wudang/obj/xiangcha");
	ob->move(this_player());
 	ob = new("d/wudang/obj/mitao");
	ob->move(this_player());
	message_vision("文清向$N一笑，又忙着招呼其他客人去了。\n", who);
