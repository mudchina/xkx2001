...
void create()
{
    set("short", "汉水南岸");
    set("long", @LONG
面前是一条波涛翻滚的大江(river)。浊流滚滚，万舟竞发。两岸渡船来来
往往，江边一长溜摆满了鱼摊，渔家就将船泊在岸边，几个破萝支一块木板，板
上摆满了活蹦乱跳的汉江鲤鱼。过去不远，是有名的老河口，不少过江客都在这
里等待渡船摆渡。
LONG
    );
    set("coordinates", ([ "x" : 0, "y" : 8 ]) );
    set("exits", ([
        "south" : __DIR__"tulu4",
        "southeast"  : __DIR__"tulu5",
    ]));
...
void arrive()
{
    ...
    if( room = find_object(__DIR__"duchuan") )
    {
        room->set("exits/out", __DIR__"hanshuin");
