...
void create()
{
	set("short", "汉水北岸");
	set("long", @LONG
汉水北岸也是相当热闹，自北岸渡口往北，一条笔直的官道直通南阳。此地
民风淳朴，路旁夹柳成阴，酒厮林立，且都有一面大大的「酒」旗迎风飘扬，蔚
为壮观。也有不少小贩沿路叫买，语多难辨，却也令人盛情难却。
LONG
	);

    set("coordinates", ([ "x" : 0, "y" : 9 ]) );
    set("exits", ([
		"north" : __DIR__"migonglu",
    ]));
...
void arrive()
{
    ...
    if( room = find_object(__DIR__"duchuan") )
    {
        room->set("exits/out", __DIR__"hanshuis");
